 ...
 * @since  2021/3/12
 */
class WsPanel(val project: Project) : IPanel {
    ...
    private var connectButton = JButton(AllIcons.Actions.Execute).apply {
        this.addActionListener {
            kotlin.run {
                websocketArchetypeClient = WebsocketArchetypeClient.start(wsAddressTextField.text, this@WsPanel)!!
    ...
    private var languageComboBox = ComboBox(arrayOf("json", "xml", "html", "plainText")).apply {
        this.addActionListener {
            ...
            wsRequestEditor = EditorManager.getEditor(this@WsPanel,this.selectedItem as String)
